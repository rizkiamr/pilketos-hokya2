...
<div class="top-bar justify-content-left fixed-top text-white" style="display:flex; width: 100% ; height: 70px;  background: #081B33;">
    ...
    <div class="container ">
        <div class="content " >
            ...
            <h3 style="padding: 20px; width:300px; background:#e0f7ff; margin:0 auto;"><?= kode(10); ?></h3>
             <br>
    ...
    <footer class=" justify-content-center  text-center bg-0" style="padding: 20px; width:100%; position:fixed; bottom:30px;">
